...
```{r sc, echo = FALSE, warning = FALSE, message = FALSE, results = 'asis'}
...
knitr::kable(list(state_weights[1:25,], state_weights[26:50,]),format = 'latex', digits = 5, booktabs = TRUE, caption = "Synthetic Control: Weights of sampled states") %>% kable_classic(full_width = T, html_font = "Cambria") %>% kable_styling(latex_options = 'hold_position')
```
