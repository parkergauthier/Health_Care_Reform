...
balance_df = sc_out %>% grab_predictors() %>% as.data.frame()

balance_df %>% 
  filter(variable == "mort_rate")

sc_out %>% grab_outcome() %>% as.data.frame()
